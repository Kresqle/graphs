...
# Generates the documentation for de_bruijn_graph_gen.ml
# Current state : basic info about De Bruijn graphs and examples of graphs generated
doc_dbgg() {
    # Variables
    ...
    table="" # stats table container
    paragraphs="" # paragraphs container
    K_MAX=4
    N_MAX=3
    ...
    do
        ...
        do
            # Creates JSON and SVG of B(k,n) and extracts the generation and render times
    ...
    printf "${table}\n" >> "${example_path}.md" # Adds table to file
    printf "${paragraphs}" >> "${example_path}.md" # Adds paragraphs to file
}

# ===== MAIN =====

# Documenting De Bruijn graphs
doc_dbgg
